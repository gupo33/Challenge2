...
namespace algebra{
    ...
    public:
        ...
        friend std::ostream& operator<< <>(std::ostream& str, const Matrix<std::complex<T>,Col>& mat);

        /// @brief Performs Matrix-vector product between two correctly-dimensioned containers of the same type
        /// @param lhs Left hand side of the operation
        /// @param rhs Right hand side of the operation
        /// @return result vector
        friend std::vector<std::complex<T>> operator* <>(const Matrix<std::complex<T>,Col>& lhs, const std::vector<std::complex<T>>& rhs);
    ...
    template<typename T> std::complex<T>& Matrix<std::complex<T>,Col>::operator()(std::size_t i, std::size_t j){
    ...
    template<typename T> std::complex<T> Matrix<std::complex<T>,Col>::operator()(std::size_t i, std::size_t j) const{
        auto it = data.find({i,j});
        if(it!=data.end()){
            return it->second;
        }
    ...
    template<typename T> void Matrix<std::complex<T>,Col>::resize(std::size_t new_row_num, std::size_t new_col_num){
        #ifdef DEBUG
    ...
    template<typename T> void Matrix<std::complex<T>,Col>::compress(){
        #ifdef DEBUG
    ...
    template<typename T> bool Matrix<std::complex<T>,Col>::is_compressed() const{
    ...
    template<typename T> void Matrix<std::complex<T>,Col>::read(std::string filename){
